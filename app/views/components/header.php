<div class="container">
  <div class="top-bar">
    ...
    >
      <!-- Ở đây mà để nhiều dấu chấm trước assets -->
      <!-- Thì vẫn chạy được -->
      <!-- Vì nó ghép vào index.html -->
      <!-- Lúc này nhảy nhiều cấp ra ngoài -->
      <!-- Thì tối đa là ra đến cấp thư mục gốc -->
      <!-- Thì cũng sẽ là ở index -->
      <!-- Nên vẫn chạy được -->
      <!-- Còn đem lên github thì sẽ bị lỗi -->
      <img
        alt=""
    ...
    <!-- Logo -->
    <a class="logo top-bar__logo" href="/BTL_LTW/LTWeb/">
      <!-- Lưu ý src chỉ 1 dấu . -->
      <!-- Dùng theo gợi ý là 2 dấu chấm -->
      <!-- Mà nội dung của file này sẽ paste ra index.html -->
      <!-- Nên 1 dấu chấm mới đúng -->
      <img
        alt="grocery"
    ...
    <!-- Actions -->
    <div class="top-act">
      <a class="btn btn--text d-md-none" href="/BTL_LTW/LTWeb/sign_in">Sign In</a>
      <a class="top-act__sign-up btn btn--primary" href="/BTL_LTW/LTWeb/sign_up"
        >Sign Up</a
      >
    </div>
  </div>
