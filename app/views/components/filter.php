<div class="filter-wrap">
    <button class="filter-btn js-toggle" toggle-target="#home-filter">
        Filter
        <img
            src="/BTL_LTW/LTWeb/public/assets/icons/filter.svg"
            alt=""
            class="filter-btn__icon icon" />
    </button>

    <div id="home-filter" class="filter hide">
        <img src="/BTL_LTW/LTWeb/public/assets/icons/arrow-up.png" alt="" class="filter__arrow" />
        ...
        <form action="" class="filter__form form">
            <div class="filter__row filter__content">
                ...
                <!-- Filter column 2 -->
                <div class="filter__col">
                    <div class="filter__form-group filter__form-group--large">
                        <div class="form__tags">
                            <div
                                class="form__tag prod-info__tag form__tag--equal">
